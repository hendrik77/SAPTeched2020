CLASS zcl_generate_dev268_174 DEFINITION
 PUBLIC
  ...
  PRIVATE SECTION.
    ...
    DATA package_name  TYPE sxco_package VALUE  'ZRAP_INVENTORY_174'.
    DATA unique_number TYPE string VALUE '174'.
...
CLASS zcl_generate_dev268_174 IMPLEMENTATION.
  METHOD main.
